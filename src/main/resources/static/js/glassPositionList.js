jQuery("document").ready(function () {
    ...
    $("#addLine").on("click", function () {
        location.pathname = "/pages/glass-position/0";
    });

    $("#deletLine").on("click", function () {
        if (curreiId !== 0) {
            $.ajax({
                url: "/glass-positions/" + curreiId,
                method: "DELETE",
                dataType: "json",
    ...
    function getItem(id) {
        location.href = "/pages/glass-position/" + id + getFilterByTypeImages();
    }
