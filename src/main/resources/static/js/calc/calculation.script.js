...
jQuery("document").ready(function () {
        ...
        const swordSound = $("#swordSoundClip")[0];
        const scrollSound = $("#scrollSoundClip")[0];
        let modalOpen = false;
            ...
            if (currentItem == "metal") {
                ...
                if (item == "doorstep") {
                    if ($(this).is(":checked")) {
                        ...
                        Door.set($(this).attr("Item"), 0);
                        Door.set("stainlessSteelDoorstep", 0);
        ...
        $(document).keyup(function (e) {
            if (selectSizeOpen) {
                processKey(e);
                checkForLimits();
            } else if (iosPicker && iosPicker.open) {
                iosPicker.processKey(e);
            }
        });
...
//--------------------------------------
        ...
        function writeInCheckbox(nameItem, tab) {
            for (var i = 0; i < tab.length; ++i) {
                ...
                if (tab[i].defaultValue == 1) {
                    ...
                    Door.set(nameItem, tab[i].startRestriction);
        ...
        function hideShowField(addHistory, newCurrentItem = null) {
            ...
            if (iosPicker && (needToSet.item != "" && needToSet.value != "")) {
                currentItem = iosPicker.setToDoor();
            }
            ...
            if (currentItem == "widthDoor") {
                ...
                if (door != null && door.widthDoor != null && door.widthDoor != 0) {
                    ...
                    iosPicker = new IosPicker(door.widthDoor, 'widthDoor_picker', 'widthDoor');
                }
                if (doorLeaf == 1) {
            ...
            if (currentItem == "heightDoor") {
                ...
                if (door != null && door.heightDoor != null && door.heightDoor != 0) {
                    ...
                    iosPicker = new IosPicker(door.heightDoor, 'heightDoor_picker', 'heightDoor');
                }
