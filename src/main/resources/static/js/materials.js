jQuery('document').ready(function () {
    ...
    function addLine(id, newName, idManufacturerProgram, price) {
        ...
        $('.Table > tbody').append('<tr class="line newLine" id="line' + Position + '">' +
            ...
            '<td class="vary_field text_input" id="name' + Position + '">' + newName + '</td>' +
            '<td class="vary_field text_input" id="value' + Position + '">' + idManufacturerProgram + '</td>' +
            '<td class="vary_field text_input" id="formula' + Position + '" >' + price + '</td>' +
            '</tr>');
