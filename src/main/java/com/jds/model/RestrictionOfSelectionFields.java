...
public class RestrictionOfSelectionFields {
    ...
    public RestrictionOfSelectionFields() {
        ...
        colors.add(new DoorColors("1013","images/Door/AColor1/1013.jpg",320));
        colors.add(new DoorColors("1014","images/Door/AColor1/1014.jpg",320));
        colors.add(new DoorColors("1015","images/Door/AColor1/1015.jpg",320));
        colors.add(new DoorColors("1021","images/Door/AColor1/1021.jpg",320));

        colors.add(new DoorColors("1028","images/Door/AColor1/1028.jpg",320));
        colors.add(new DoorColors("1034","images/Door/AColor1/1034.jpg",320));
        colors.add(new DoorColors("2004","images/Door/AColor1/2004.jpg",320));
        colors.add(new DoorColors("2005","images/Door/AColor1/2005.jpg",320));
        colors.add(new DoorColors("3003","images/Door/AColor1/3003.jpg",320));

        colors.add(new DoorColors("3012","images/Door/AColor1/3012.jpg",320));
        colors.add(new DoorColors("3020","images/Door/AColor1/3020.jpg",320));
        colors.add(new DoorColors("4003","images/Door/AColor1/4003.jpg",320));
        colors.add(new DoorColors("5002","images/Door/AColor1/5002.jpg",320));
        colors.add(new DoorColors("5005","images/Door/AColor1/5005.jpg",320));
