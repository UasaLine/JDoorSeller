...
public class ImageEntity implements LimiItem, SerializingFields, Comparable<ImageEntity> {
    ...
    @Column(name = "peepholeOnlyEdge")
    private int peepholeOnlyEdge;
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "outShieldDesign")
    private List<ImageEntity> outShieldDesign;
